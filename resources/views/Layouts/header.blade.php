...
<html>
  <head>
    ...
    <title>Finsso Financial Services</title>
   ...
   <link href="dist/css/jquery.fastconfirm.css" rel="stylesheet" type="text/css" media="screen" />
    ...
    <link rel="stylesheet" href="dist/css/jqueryui.css"/>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{route('home')}}" class="logo">
          ...
          <span class="logo-mini"><b>FFS</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Finsso Financial Services</b></span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation" style="background-color: #fff;">
          ...
          <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button" style="color:#1a8c4f;">
            <span class="sr-only">Toggle navigation</span>
          </a>
          <h4 class="pull-left" style="margin-left: 2.5%;line-height:2;">Welcome
           Ayush
            </h4>
             ...
             <!-- Notifications: style can be found in dropdown.less -->
              ...
              <!-- User Account: style can be found in dropdown.less -->
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs" style="color: #000;">ayush.ptl2210@gmail.com</span>
                </a>
