...
<section class="content">
    ...
    <div class="">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <div class="box-body">
                <form role="form" class="form-horizontal" name="editleadform" id="editleadform"  method="post" action="<?php echo e(route('lead-process',['id'=> $item->leads_id])); ?>" autocomplete="off" enctype="multipart/form-data">
                 ...
                 <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <div class="col-lg-8">
                      <input type="text" class="form-control isRequired"  id="proposerName" name="proposerName" value="" placeholder="Enter IPO Title" title="Please enter IPO Title" />
                     </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                       ...
                       <div class="col-sm-8">
                         <input type="text" class="form-control isRequired" id="titleSlug" name="titleSlug"  placeholder="IPO slug" title="Please enter IPO Slug" />
                       </div>
                    </div>
                   </div>
                  </div>
...
<?php echo $__env->make("footer.php", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php /**PATH C:\xampp\htdocs\Finsso\resources\views/edit-lead.blade.php ENDPATH**/ ?>